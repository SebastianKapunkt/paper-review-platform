...
@app.route('/index')
def index():
    """renders the index.html on /index request"""
...
def signup():
    ...
    if request.method == "POST":
        ...
        user_controller.create_user(username, email.lower(), password, first_name, last_name)
        flash('Welcome to Paper-Reviewer {username} ,you have successfuly registered')
